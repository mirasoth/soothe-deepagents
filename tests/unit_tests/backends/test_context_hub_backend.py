...
from soothe_deepagents.backends import CompositeBackend, ContextHubBackend, FilesystemBackend
...
def test_default_client_constructed_when_not_provided() -> None:
    ...
    with patch("soothe_deepagents.backends.context_hub.Client") as mock_client_cls:
        ContextHubBackend("-/x")
