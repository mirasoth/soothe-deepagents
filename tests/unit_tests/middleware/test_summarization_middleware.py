...
from soothe_deepagents.backends.protocol import BackendProtocol, EditResult, FileDownloadResponse, FileUploadResponse, ReadResult, WriteResult
...
def mock_get_config(thread_id: str | None = "test-thread-123") -> Generator[None, None, None]:
    ...
    with patch("soothe_deepagents.middleware.summarization.get_config", return_value=config):
        yield
