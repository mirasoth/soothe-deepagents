...
from soothe_deepagents.backends.protocol import FileDownloadResponse, FileInfo, LsResult
...
"""
    ...
    with caplog.at_level(logging.WARNING, logger="soothe_deepagents.middleware.skills"):
...
class TestSkillMetadataFromResponseLogging:
    ...
    def test_is_directory_error_emits_warning(self, caplog: pytest.LogCaptureFixture) -> None:
        ...
        with caplog.at_level("WARNING", logger="soothe_deepagents.middleware.skills"):
...
def test_format_skills_locations_skills_leaf_climbs_to_parent() -> None:
    ...
    middleware = SkillsMiddleware(
        ...
        sources=[
            ...
            "/home/me/.soothe_deepagents/skills",
        ],
    )
