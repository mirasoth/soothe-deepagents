...
class TestSubAgents:
    ...
    def test_subagent_inherits_parent_user_metadata(self) -> None:
        """User metadata set on the parent invoke reaches subagent runs (soothe_deepagents#3634).
    ...
    def test_subagent_propagates_callbacks_to_model_calls(self) -> None:
        ...
        Regression test for https://github.com/langchain-ai/soothe_deepagents/issues/2315.
        """
