...
with a soothe_deepagents-specific addendum explaining the media reference tags that the
        ...
        **deprecated_kwargs: Any,
        ...
        Args:
            ...
            truncate_args_settings: Settings for truncating large tool arguments in old messages.
                ...
                Provide a [`TruncateArgsSettings`][soothe_deepagents.middleware.summarization.TruncateArgsSettings]
...
def create_summarization_middleware(
    ...
    *,
    ...
    ## Why this exists in `soothe_deepagents`
    ...
    - **Auto-selected trigger/keep thresholds.** LangChain accepts
        ...
        [`compute_summarization_defaults`][soothe_deepagents.middleware.summarization.compute_summarization_defaults].
...
def create_summarization_tool_middleware(
    ...
    *,
    ...
    [`create_summarization_middleware`][soothe_deepagents.middleware.summarization.create_summarization_middleware]
    ...
    Example:
        ...
        ```
    """
    from soothe_deepagents._models import resolve_model  # noqa: PLC0415
...
class SummarizationToolMiddleware(AgentMiddleware):
    ...
    an explicit user action, e.g. as implemented in the soothe_deepagents-cli).
