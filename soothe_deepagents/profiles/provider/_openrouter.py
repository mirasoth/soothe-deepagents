...
from soothe_deepagents.profiles.provider.provider_profiles import ProviderProfile, _register_provider_profile_impl
...
_OPENROUTER_APP_URL = "https://github.com/mirasoth/soothe-deepagents"
...
def check_openrouter_version() -> None:
    ...
    if is_old:
        msg = (
            f"soothe_deepagents requires langchain-openrouter>={OPENROUTER_MIN_VERSION}, "
