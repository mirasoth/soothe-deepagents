...
from soothe_deepagents.profiles._keys import validate_profile_key
...
def _scaffolding_violation_label(entry: object) -> str | None:
    ...
    The required-scaffolding set is owned by `soothe_deepagents.graph` and imported
    ...
    module load.
    """
    from soothe_deepagents.graph import _REQUIRED_MIDDLEWARE_NAMES  # noqa: PLC0415
...
class HarnessProfileConfig:
    ...
    Example:
        ...
        ```python
        from soothe_deepagents import HarnessProfileConfig, register_harness_profile
    ...
    [Prompt assembly](https://docs.langchain.com/oss/soothe_deepagents/customization#prompt-assembly)
...
class HarnessProfile:
    ...
    Example:
        ...
        ```python
        from soothe_deepagents import HarnessProfile, register_harness_profile
...
def _ensure_harness_profiles_loaded() -> None:
    ...
    from soothe_deepagents.profiles._builtin_profiles import _ensure_builtin_profiles_loaded  # noqa: PLC0415
...
def _harness_profile_for_model(model: BaseChatModel, spec: str | None) -> HarnessProfile:
    ...
    from soothe_deepagents._models import get_model_identifier, get_model_provider  # noqa: PLC0415
